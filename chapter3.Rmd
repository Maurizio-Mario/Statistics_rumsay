...
The minimum number of sales was `r min(e13$sales)`, and the maximum `r max(e13$sales`. They occurred on the `r paste(which.min(e13$sales), "th", sep ="")` and `r paste(which.max(e13$sales), "%", sep ="")` days.
