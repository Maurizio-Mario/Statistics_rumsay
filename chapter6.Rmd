...
Bob scores 80 on both his math exam (which has a mean of 70 and standard deviation on 10) and his English exam (which has a mean of 85 and a standard deviation of 5). Fin and interpret Bob's z-scores on both exams to let him know wich exam (if either) he did better on.
